...
async function mountChat(force) {
 ...
 function(page) return host.navigate(page) end, "search")
 ...
 throw Error("Chat is waiting for wiki APIs; use Search: Focus to retry");
}
...
const manifest={name:"iugum-search",version:1,functions:{
 openChat:{path:"./chief.js:openChat",command:{name:"Search: Focus"}},
