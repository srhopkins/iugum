...
#   scripts/atomdown-fe-check.sh --rule 1   # one rule only (1 to 12)
...
#
# THE DEFAULT RUNS EVERY RULE: 1 to 8, 10, 11 and 12 behaviourally, plus 9,
# which
...
while [ $# -gt 0 ]; do
  case "$1" in
    ...
    # the visual one; 1 to 8, 10, 11 and 12 are behavioural.
    --rule) GREP="$2"
